...
<head>
    ...
    <link
        ...
        <link href="{{ asset('assets/vendors/animate/custom-animate.css') }}" />
        <link href="{{ asset('assets/vendors/bootstrap/css/bootstrap.min.css') }}" />
        <link href="{{ asset('assets/vendors/bootstrap-select/css/bootstrap-select.min.css') }}" />
        <link href="{{ asset('assets/vendors/bxslider/jquery.bxslider.css') }}" />
        <link href="{{ asset('assets/vendors/fontawesome/css/all.min.css') }}" />
        <link href="{{ asset('assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css') }}" />
        <link href="{{ asset('assets/vendors/jquery-ui/jquery-ui.css') }}" />
        <link href="{{ asset('assets/vendors/nice-select/nice-select.css') }}" />
        <link href="{{ asset('assets/vendors/nouislider/nouislider.min.css') }}" />
        <link href="{{ asset('assets/vendors/nouislider/nouislider.pips.css') }}" />
        <link href="{{ asset('assets/vendors/odometer/odometer.min.css') }}" />
        <link href="{{ asset('assets/vendors/owl-carousel/owl.carousel.min.css') }}" />
        <link href="{{ asset('assets/vendors/owl-carousel/owl.theme.default.min.css') }}" />
        <link href="{{ asset('assets/vendors/swiper/swiper.min.css') }}" />
        <link href="{{ asset('assets/vendors/timepicker/timePicker.css') }}" />
        <link href="{{ asset('assets/vendors/tiny-slider/tiny-slider.min.css') }}" />
        <link href="{{ asset('assets/vendors/vegas/vegas.min.css') }}" />
        <link href="{{ asset('assets/vendors/thm-icons/style.css') }}">
        <link href="{{ asset('assets/vendors/slick-slider/slick.css') }}">
        <link href="{{ asset('assets/vendors/language-switcher/polyglot-language-switcher.css') }}">
        <link href="{{ asset('assets/vendors/reey-font/stylesheet.css') }}">

        <!-- template styles -->
        <link href="{{ asset('assets/css/style.css') }}" />
        <link href="{{ asset('assets/css/responsive.css') }}" />
