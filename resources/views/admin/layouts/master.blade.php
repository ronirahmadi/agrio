...
<head>
  ...
  <title>Dashboard Admin &mdash; NSI</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.main') }}"><i class="fas fa-fire"></i><span>Dashboard</span></a>
            </li>
    
            <li class="menu-header">Laporan</li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-user"></i> <span>Data Laporan</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.laporan') }}">Daftar Laporan</a></li>
                    <li><a class="nav-link" href="#">Tambah Laporan</a></li>
                </ul>
            </li>
        
            <li class="menu-header">Lahan</li>
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-plug"></i> <span>Daftar Lahan</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('admin.list-lahan') }}">Data Lahan</a></li>
                </ul>
            </li>
          </ul>
